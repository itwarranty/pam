...
- **WHEN** user runs `bastion-session-search --operator engineer1 --since 7d`
...
- **WHEN** `bastion_session_search_enabled: true`
- **THEN** playbook or docs SHALL ensure `jq` package on bastion host
