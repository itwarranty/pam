...
- **THEN** `pam_ssh_user_ca_qa_complete: true` SHALL be set in internal prod group_vars
...
- **WHEN** `pam-compliance-verify.sh` runs on healthy internal prod
