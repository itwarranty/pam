...
| **v1.2.0** | Security hardening + archive | Audit argv, PTY line-gate, PGID kill, MFA lifecycle, deploy safety |
...
| [2026-08-pam-security-hardening](./2026-08-pam-security-hardening/) | v1.2.0 | Security hardening — **§5.9/11.4 optional Lima [ ]** |
