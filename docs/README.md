...
| [CSO-Demo-Runbook.md](./CSO-Demo-Runbook.md) | Пресейл | Demo lab (Tier 1–5) |
| [Battlecard-SKDPU-SSH.md](./Battlecard-SKDPU-SSH.md) | Пресейл | Сравнение с СКДПУ SSH |
| [SoW-SSH-Access.md](./SoW-SSH-Access.md) | Юристы | Формулировка для договора |
| [HA-Runbook.md](./HA-Runbook.md) | SRE | Active-passive HA |
| [FIDO-Onboarding.md](./FIDO-Onboarding.md) | CSO, операторы | FIDO-sk + TOTP (Tier 5) |
| [Engineer-Onboarding.md](./Engineer-Onboarding.md) | Инженеры  | Git-доступ, dev-up, первый SSH |
